...
import pl.lh.expenses.config.audit.AuditEventConverter;
import pl.lh.expenses.domain.PersistentAuditEvent;
...
import static pl.lh.expenses.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
