...
import pl.lh.expenses.config.Constants;
import pl.lh.expenses.ExpensesApp;
import pl.lh.expenses.domain.Authority;
import pl.lh.expenses.domain.User;
import pl.lh.expenses.repository.AuthorityRepository;
import pl.lh.expenses.repository.UserRepository;
import pl.lh.expenses.security.AuthoritiesConstants;
import pl.lh.expenses.service.MailService;
import pl.lh.expenses.service.dto.UserDTO;
import pl.lh.expenses.web.rest.errors.ExceptionTranslator;
import pl.lh.expenses.web.rest.vm.KeyAndPasswordVM;
import pl.lh.expenses.web.rest.vm.ManagedUserVM;
import pl.lh.expenses.service.UserService;
